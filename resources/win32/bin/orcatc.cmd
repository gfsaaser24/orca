...
setlocal
set "SCRIPT_DIR=%~dp0"
set "LAUNCHER=%SCRIPT_DIR%orcatc.exe"

if not exist "%LAUNCHER%" (
  echo Unable to locate the native Orca TC CLI launcher at "%LAUNCHER%" 1>&2
  exit /b 1
)
...
:unsafe_body
echo orcatc.cmd cannot safely forward orchestration message bodies. Use "%LAUNCHER%" instead. 1>&2
exit /b 2
